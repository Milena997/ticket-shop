  ...
  return (
    <div className="flex px-[150px] h-full">
      <div
        ...
        className={`test-klasa relative !bg-no-repeat !bg-center  bg-cover border shadow-md shadow-gray-500 rounded-md  m-[0 auto] w-full h-96 px-5 py-4  flex flex-col `}
      >
        ...
        <div className="flex flex-1 justify-between items-end  z-10 ">
          <div
