...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center h-[100vh] flex-col gap-10 bg-[#232323]">
      <div className="flex flex-col gap-4 ">
        <div className="text-white text-2xl font-bold">Email:</div>
        <input
          className="min-w-80 py-2 rounded  px-4  text-[#ccc] box-border text-base outline-none border-t-0 border-l-0 border-r-0 border-b-0 "
          name="firstName"
          value={emailValue}
      ...
      <div className=" flex flex-col gap-4">
        ...
        <input
          name="password"
          type="password"
          className="min-w-80 py-2 px-4 rounded   text-[#ccc] box-border text-base outline-none border-t-0 border-l-0 border-r-0 border-b-0 shadow-[]"
          value={passwordValue}
          onChange={(e) => handlePasswordChange(e)}
        />
      </div>
      <button
        className="text-white px-16 py-2 rounded hover:bg-white hover:!text-black"
        onClick={handleLogin}
      >
        Login
      </button>
